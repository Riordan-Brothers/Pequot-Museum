...
namespace UserModule_RBI_PHOTOCELL_LIST_V6
{
    public class UserModuleClass_RBI_PHOTOCELL_LIST_V6 : SplusObject
    {
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        CreateWait ( "__SPLS_TMPVAR__WAITLABEL_69__" , 200 , __SPLS_TMPVAR__WAITLABEL_69___Callback ) ;
...
public void __SPLS_TMPVAR__WAITLABEL_69___CallbackFn( object stateInfo )
{
...
public override void LogosSplusInitialize()
{
    ...
    __SPLS_TMPVAR__WAITLABEL_69___Callback = new WaitFunction( __SPLS_TMPVAR__WAITLABEL_69___CallbackFn );
...
public UserModuleClass_RBI_PHOTOCELL_LIST_V6 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}


private WaitFunction LISTCHANGEWAIT_Callback;
private WaitFunction __SPLS_TMPVAR__WAITLABEL_69___Callback;
