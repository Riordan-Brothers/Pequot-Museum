...
namespace UserModule_RBI_ROOM_LIST_V2
{
    public class UserModuleClass_RBI_ROOM_LIST_V2 : SplusObject
    {
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        CreateWait ( "__SPLS_TMPVAR__WAITLABEL_68__" , 200 , __SPLS_TMPVAR__WAITLABEL_68___Callback ) ;
...
public void __SPLS_TMPVAR__WAITLABEL_68___CallbackFn( object stateInfo )
{
...
public override void LogosSplusInitialize()
{
    ...
    __SPLS_TMPVAR__WAITLABEL_68___Callback = new WaitFunction( __SPLS_TMPVAR__WAITLABEL_68___CallbackFn );
...
public UserModuleClass_RBI_ROOM_LIST_V2 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}


private WaitFunction LISTCHANGEWAIT_Callback;
private WaitFunction __SPLS_TMPVAR__WAITLABEL_68___Callback;
