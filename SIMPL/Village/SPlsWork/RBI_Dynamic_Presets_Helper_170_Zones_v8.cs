...
namespace UserModule_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V8
{
    public class UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V8 : SplusObject
    {
...
public UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V8 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
