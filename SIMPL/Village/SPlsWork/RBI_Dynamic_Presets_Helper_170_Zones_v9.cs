...
namespace UserModule_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V9
{
    public class UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V9 : SplusObject
    {
        ...
        private void INIT_PRESET (  SplusExecutionContext __context__, CrestronString PRESET_NAME ) 
            ...
            if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( NFILEFOUND < 0 ))  ) ) 
                ...
                ushort __FN_FOREND_VAL__1 = (ushort)170; 
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( NFILEHANDLE < 0 ))  ) ) 
                    ...
                    IERRORCODE = (short) ( FileRead( (short)( NFILEHANDLE ) , FILE_CONTENTS , (ushort)( 4000 ) ) ) ; 
...
public override void LogosSplusInitialize()
{
    ...
    SBUF  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 4000, this );
    FILE_CONTENTS  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 4000, this );
    ...
    LEVEL_IN = new InOutArray<AnalogInput>( 170, this );
    ...
    LEVEL_OUT = new InOutArray<AnalogOutput>( 170, this );
    for( uint i = 0; i < 170; i++ )
    {
...
public UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_170_ZONES_V9 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
