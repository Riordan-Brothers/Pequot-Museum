...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        CreateWait ( "__SPLS_TMPVAR__WAITLABEL_29__" , 200 , __SPLS_TMPVAR__WAITLABEL_29___Callback ) ;
...
public override void LogosSplusInitialize()
{
    ...
    ROOMSELECT = new InOutArray<DigitalInput>( 65, this );
    for( uint i = 0; i < 65; i++ )
    {
    ...
    ROOMNAMES = new InOutArray<StringOutput>( 65, this );
    for( uint i = 0; i < 65; i++ )
    {
